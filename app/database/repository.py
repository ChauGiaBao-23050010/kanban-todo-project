...
# Generic types để làm cho BaseRepository có thể tái sử dụng
...
class BaseRepository(Generic[ModelType, CreateSchemaType, UpdateSchemaType]):
    def __init__(self, model: Type[ModelType]):
        """
        Base class cho các thao tác CRUD.
        :param model: Một model SQLAlchemy
        """
        self.model = model
...
# Tạo các instance toàn cục để sử dụng trong các router
